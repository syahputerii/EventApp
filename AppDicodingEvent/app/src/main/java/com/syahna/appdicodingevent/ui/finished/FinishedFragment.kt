package com.syahna.appdicodingevent.ui.finished
...
import com.syahna.appdicodingevent.databinding.FragmentFinishedBinding
...
class FinishedFragment : Fragment() {
    ...
    private fun initializeRecyclerView() {
        eventAdapter = EventAdapter(emptyList()) { event -> openEventDetails(event) }
        binding.rvEvent.layoutManager = LinearLayoutManager(requireContext())
        binding.rvEvent.adapter = eventAdapter
    }

    private fun setupSearchBar() {
        val searchField: TextInputEditText = binding.searchBar.findViewById(R.id.searchEditText)
    ...
    private fun filterEvents(query: String) {
        val events = finishedViewModel.listEvents.value ?: emptyList()
    ...
    private fun openEventDetails(event: ListEventsItem) {
